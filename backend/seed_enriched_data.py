...
BUSINESSES = {
    ...
    "business@demo.com": {
        ...
        "rev_categories": ["Software Development", "IT Consulting", "Support Contract", "Cloud Migration"],
        "exp_categories": ["Staff Salary", "Cloud Infrastructure", "Office Rent", "Internet", "Equipment", "Training"],
